 ...
 * Currently backed by the local Mock Engine.
 * Ready for drop-in replacement with real backend endpoints:
 *   - GET  /api/services
 *   - GET  /api/services/:id
 *   - GET  /api/metrics
 *   - GET  /api/logs
...
class ApiClient {
  ...
  async getServices() {
    ...
    // Return mock services (handled via reactive StateStore)
    return null;
  }
